...
public class Check_API_Basket {

    public static void checkResponse() {
        StringBuilder response = sendToAmo("{\"name\":\"Supertester_Basket_MZPO\"}");// поскольку метод sendToAmo включает и отправку, и ответ от сервера, то задержку поставила внутри метода этого
